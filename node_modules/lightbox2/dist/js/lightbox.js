...
(function (root, factory) {
  ...
  Lightbox.prototype.build = function() {
    ...
    this.$download       = this.$lightbox.find('.lb-download');
    ...
    this.$download.on('click keyup', function(e) {
      if (e.type === 'click' || (e.type === 'keyup' && (e.which === 13 || e.which === 32))) {
        var imageUrl = self.album[self.currentImageIndex].link;
        var fileName = imageUrl.split('/').pop().split('?')[0] || 'download';
        fetch(imageUrl)
